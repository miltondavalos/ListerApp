...
class ListItemTests: XCTestCase {
    ...
    /**
        ...
        compatibility with earlier versions of the app.
    */
    func testClassRuntimeNameForArchiveCompatibility() {
        let classRuntimeName = NSStringFromClass(ListItem.self)

        XCTAssertEqual(classRuntimeName, "AAPLListItem", "ListItem should be archivable with earlier versions of Lister.")
    }
}
